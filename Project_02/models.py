...
# NB: Make sure to add flask_user UserMixin as this adds additional fields
# and properties required by Flask-User
...
class MovieTags(db.Model):
    ...
    movie_id = db.Column(db.Integer,
                         db.ForeignKey('movies.id'),
                         nullable=False)
    tag = db.Column(db.String(255, collation='NOCASE'), nullable=False)
